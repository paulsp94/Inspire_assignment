...
public class BuildAll {
	...
	public static void main(String[] args) throws IOException {
		...
		InfrequentPositionalQgramInvertedIndex infrequentQgramIndex = new InfrequentPositionalQgramInvertedIndex(
				indexFile, qgramLength);
		...
		// if there are few objects in having the positional q-grams, save them
		// in the
		// infrequent q-gram
		// inverted index
	...
	public static void indexBuilding(String indexFile, int qgramLength, int largerQgramLength, int positionUpperBound,
			int maxElement, int infrequentThreshold, int sparseThreshold, QuadTree quadtree,
